...
# catalogo = Catalogo(host="localhost", user="root", password="", database="miapp")
catalogo = Catalogo(host='fedefer85.mysql.pythonanywhere-services.com', user='fedefer85', password='root-123456', database='fedefer85$miapp')

# Carpeta para guardar las imagenes
#ruta_destino = './static/imagenes/'
ruta_destino = '/home/fedefer85/mysite/static/imagenes/'   #recordar poner / después de imágenes
